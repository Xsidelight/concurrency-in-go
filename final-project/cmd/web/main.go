...
func initSession() *scs.SessionManager {
	// register the type we want to store in the session
...
func (app *Config) listenForShutdowns() {
...
func (app *Config) createMail() Mail {
	...
	// these fields normally come from env or terminal flags or etc..
	m := Mail{
		Domain:      "localhost",
		Host:        "localhost",
		Port:        1025,
